    ...
    <nav style={{ background: '#050805', borderBottom: '1px solid #1a2e1e', position: 'sticky', top: 0, zIndex: 100 }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '52px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <Link href="/terminal" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#00ff41', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(0,255,65,0.2)', borderRadius: '3px', background: 'rgba(0,255,65,0.04)' }}>TERM</Link>
          <Link href="/payload" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#bf5fff', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(191,95,255,0.3)', borderRadius: '3px', background: 'rgba(191,95,255,0.06)' }}>PAYLOADS</Link>
          <Link href="/crypto-tracer" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#ffb347', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(255,179,71,0.3)', borderRadius: '3px', background: 'rgba(255,179,71,0.06)' }}>TRACER</Link>
          <Link href="/ctf" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#00ff41', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(0,255,65,0.2)', borderRadius: '3px', background: 'rgba(0,255,65,0.04)' }}>CTF</Link>
          <Link href="/modules/active-directory" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#ff4136', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(255,65,54,0.2)', borderRadius: '3px', background: 'rgba(255,65,54,0.04)' }}>AD</Link>
          <Link href="/modules/web-attacks" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#00d4ff', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(0,212,255,0.2)', borderRadius: '3px', background: 'rgba(0,212,255,0.04)' }}>WEB+</Link>
          <Link href="/modules/malware" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '8px', color: '#00ff41', letterSpacing: '0.1em', padding: '4px 8px', border: '1px solid rgba(0,255,65,0.2)', borderRadius: '3px', background: 'rgba(0,255,65,0.04)' }}>MAL</Link>
