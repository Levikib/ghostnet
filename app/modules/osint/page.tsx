    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '2rem', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', color: '#5a7a5a' }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: '8px' }}>
          ...
          <Link href="/modules/osint/lab" style={{ textDecoration: 'none', padding: '3px 10px', background: 'rgba(0,212,255,0.1)', border: '1px solid rgba(0,212,255,0.5)', borderRadius: '3px', color: '#00d4ff', fontSize: '8px', letterSpacing: '0.15em', fontWeight: 700 }}>LAB →</Link>
        </div>
      </div>
...
exiftool -all= screenshot.png`}</Pre>
      ...
      <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid #1a2e1e' }}>
        <div style={{ background: 'rgba(0,212,255,0.04)', border: '1px solid rgba(0,212,255,0.2)', borderRadius: '8px', padding: '2rem', textAlign: 'center', marginBottom: '1.5rem' }}>
          ...
          <div style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: '1rem', color: '#00d4ff', marginBottom: '0.5rem', fontWeight: 600 }}>MOD-02 Interactive Lab</div>
          ...
          <Link href="/modules/osint/lab" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.85rem', color: '#00d4ff', padding: '12px 32px', border: '1px solid rgba(0,212,255,0.6)', borderRadius: '6px', background: 'rgba(0,212,255,0.1)', fontWeight: 700, letterSpacing: '0.12em', boxShadow: '0 0 20px rgba(0,212,255,0.15)', display: 'inline-block' }}>
            LAUNCH LAB &#8594;
          </Link>
        </div>
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          <Link href="/modules/tor" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.75rem', color: '#3a6a3a' }}>&#8592; MOD-01: TOR</Link>
