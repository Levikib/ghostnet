...
export default function CVEFeed() {
  ...
  return (
    <>
      <button onClick={() => setOpen(!open)} style={{ position: 'fixed', bottom: '130px', right: '24px', zIndex: 9000, background: 'rgba(255,65,54,0.08)', border: '1px solid rgba(255,65,54,0.3)', borderRadius: '6px', padding: '6px 12px', cursor: 'pointer', fontFamily: 'JetBrains Mono, monospace', fontSize: '9px', color: '#ff4136', letterSpacing: '0.1em', display: 'flex', alignItems: 'center', gap: '6px' }}>
      ...
      {open && (
        <div style={{ position: 'fixed', bottom: '170px', right: '24px', zIndex: 9001, width: '420px', height: '520px', background: '#080c0a', border: '1px solid rgba(255,65,54,0.2)', borderRadius: '10px', display: 'flex', flexDirection: 'column', fontFamily: 'JetBrains Mono, monospace', overflow: 'hidden' }}>
